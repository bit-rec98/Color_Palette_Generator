...
const structure = {
    ...
    gradientPaletteBtn: document.getElementById('gradientPaletteBtn'),
    copySolidColorBtn: document.getElementById('copySolidColorBtn'),
    copyGradientColorsBtn: document.getElementById('copyGradientColorsBtn'),
